...
class Cache(ABC):
    ...
    """
    @abstractmethod
    async def is_cached(self, product: Product, product_url: str) -> bool:
        """
    ...
    @abstractmethod
    async def is_price_changed(self, product: Product, product_url: str) -> bool:
        """
    ...
    @abstractmethod
    async def update_cache(self, product: Product, product_url: str):
        """
...
class RedisCache(Cache):
    ...
    async def is_cached(self, product: Product, product_url: str) -> bool:
        ...
        Check if the product is cached.
        """
        cached_product = await self.redis.get(product_url)
    ...
    async def update_cache(self, product: Product, product_url: str):
        ...
        Update the cache with the given product details.
        """
        await self.redis.set(product_url, product.model_dump_json())
